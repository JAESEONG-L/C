...
int* solution(int e, int starts[], size_t starts_len) {
    ...
    int powerNums[8][23]= {{0, }, {0, }, {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1048576, 2097152, 4194304}, {1, 3, 9, 27, 81, 243, 729, 2187, 6561, 19683, 59049, 177147, 531441, 1594323, 4782969, }, {0, }, {1, 5, 25, 125, 625, 3125, 15625, 78125, 390625, 1953125, }, {0, }, {1, 7, 49, 343, 2401, 16807, 117649, 823543, }};
    ...
    int pnCounts[8]= {0, 0, 22, 14, 0, 9, 0, 7};    // Look up for powerNums[][].
